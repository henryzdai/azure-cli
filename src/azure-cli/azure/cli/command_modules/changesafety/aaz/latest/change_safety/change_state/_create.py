...
class Create(AAZCommand):
    ...
    def _handler(self, command_args):
        ...
        raw_ops = command_args.pop('targets', None)
        print('DEBUG raw_ops', raw_ops)
        extracted_targets = self._extract_targets_from_operations(raw_ops)
        print('DEBUG extracted targets', extracted_targets)
    ...
    def _apply_targets_to_args(self, values):
        ...
        print('DEBUG applying targets to args:', values)
        targets_value.clear()
        for token in values:
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        # define Arg Group "Properties changeDefintion"
        return cls._args_schema
    ...
    def _build_change_definition(self):
        ...
        change_name = self.ctx.args.change_state_name
    ...
    class ChangeStatesCreateOrUpdateAtSubscriptionLevel(AAZHttpOperation):
        ...
        def content(self):
            ...
            if properties is not None:
                ...
                properties.set_const("changeDefinition", self.ctx.vars.change_definition, AAZAnyType)
                properties.set_const("changeDefinition", self.ctx.vars.change_definition, AAZAnyType)
        ...
        def _build_schema_on_200_201(cls):
            ...
            targets = cls._schema_on_200_201.properties.targets
            ...
            print('DEBUG _schema_on_200_201', cls._schema_on_200_201)
